...
Marker_Gaofeng_filter = read_excel("Barley-GxP/Genotype-homozygous_wo_9chromosome.hmp.xlsx", trim_ws = TRUE)
...
save(Marker_Gaofeng_filter, file="outputs/Marker_Gaofeng_filter_processed.RData")
