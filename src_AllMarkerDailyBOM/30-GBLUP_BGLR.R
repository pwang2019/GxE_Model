...
GBLUP_G_AMarker_BOM_ZS49 = GBLUP
GBLUP_GE_AMarker_BOM_ZS49 = GBLUP_G
GBLUP_GEGxE_AMarker_BOM_ZS49 = GBLUP_GEGxE
y_AMarker_BOM_ZS49 = y
test_index.AMarker_BOM_ZS49 = test.index

GBLUP_G_AMarker_BOM_GrYld = GBLUP
GBLUP_GE_AMarker_BOM_GrYld = GBLUP_G
GBLUP_GEGxE_AMarker_BOM_GrYld = GBLUP_GEGxE
y_AMarker_BOM_GrYld = y
test_index.AMarker_BOM_GrYld = test.index

GBLUP_G_AMarker_BOM_ZS49_NewSite = GBLUP
GBLUP_GE_AMarker_BOM_ZS49_NewSite = GBLUP_G
GBLUP_GEGxE_AMarker_BOM_ZS49_NewSite = GBLUP_GEGxE
y_AMarker_BOM_ZS49_NewSite = y
test_index.AMarker_BOM_ZS49_NewSite = test.index

GBLUP_G_AMarker_BOM_GrYld_NewSite = GBLUP
GBLUP_GE_AMarker_BOM_GrYld_NewSite = GBLUP_G
GBLUP_GEGxE_AMarker_BOM_GrYld_NewSite = GBLUP_GEGxE
y_AMarker_BOM_GrYld_NewSite = y
test_index.AMarker_BOM_GrYld_NewSite = test.index

######################################################################################################################################
##save models
save(GBLUP_G_AMarker_BOM_ZS49, GBLUP_GE_AMarker_BOM_ZS49, GBLUP_GEGxE_AMarker_BOM_ZS49, y_AMarker_BOM_ZS49,test_index.AMarker_BOM_ZS49, 
     GBLUP_G_AMarker_BOM_GrYld,GBLUP_GE_AMarker_BOM_GrYld,GBLUP_GEGxE_AMarker_BOM_GrYld,y_AMarker_BOM_GrYld,test_index.AMarker_BOM_GrYld,
     file = "outputs/models/GBLUP_AMarker_BOM_80-20.RData")

save(GBLUP_G_AMarker_BOM_ZS49_NewSite, GBLUP_GE_AMarker_BOM_ZS49_NewSite, GBLUP_GEGxE_AMarker_BOM_ZS49_NewSite, y_AMarker_BOM_ZS49_NewSite,test_index.AMarker_BOM_ZS49_NewSite,
     GBLUP_G_AMarker_BOM_GrYld_NewSite,GBLUP_GE_AMarker_BOM_GrYld_NewSite,GBLUP_GEGxE_AMarker_BOM_GrYld_NewSite,y_AMarker_BOM_GrYld_NewSite,test_index.AMarker_BOM_GrYld_NewSite
     file = "outputs/models/GBLUP_AMarker_BOM_site.RData")
